...
function SortIcon({ field, ordering }) {
  if (!ordering) return <ChevronsUpDown className="w-3 h-3 text-gray-300" />;
  ...
  return (
    <div className="flex items-center justify-between px-4 py-3 border-t border-gray-100 dark:border-gray-700 text-xs text-gray-500 dark:text-gray-400">
        ...
        {onPageSizeChange && (
          <div className="flex items-center gap-1.5">
            ...
            <select
              ...
              className="border border-gray-200 dark:border-gray-600 rounded px-1.5 py-0.5 bg-white dark:bg-gray-800 text-xs"
            >
      ...
      <div className="flex items-center gap-1">
        ...
        {/* Page number chips — show up to 7 pages */}
...
export default function DataTable({
  ...
  return (
    <div className="flex flex-col rounded-xl border border-gray-100 dark:border-gray-700 overflow-hidden bg-white dark:bg-gray-900">
        ...
        <div className="ml-auto flex items-center gap-2 min-w-[200px]">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-8 pr-3 py-1.5 text-xs border border-gray-200 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-brand-500/30 focus:border-brand-500"
            />
          </div>
        </div>
      </div>
      ...
      {/* ── Error state ── */}
      {error && !loading && (
        <div className="px-6 py-8 text-center text-sm text-danger-600 dark:text-danger-400">
          {error}
        </div>
      )}
